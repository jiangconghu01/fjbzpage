        ...
        <div class="icon-item">
          <div class="layout">
            ...
            <div class="text data">
              {{
                view_1_obj[0]
                  ? format(Number(view_1_obj[0].idxValue).toFixed(0))
                  : 0
              }}个
            </div>
          </div>
        ...
        <div class="icon-item">
          <div class="layout">
            ...
            <div class="text data">
              {{
                view_1_obj[7]
                  ? format(Number(view_1_obj[7].idxValue / 10000).toFixed(2))
                  : 0
              }}万元/{{
    ...
    <div class="left view_3 bg_title">
      ...
      <Title class="title">
        ...
        <Poptip trigger="hover" class="tip-box" placement="top-start">
              <i
        ><img class="tip-icon" src="../../static/qusetion.jpg" alt=""
        /></i>
        <div slot="title">
                <i>户均酬金</i>
        </div>
      ...
      <Button-group size="small" class="btn-switch">
        <i-button
          type="primary"
          :class="[view3 == 'compare' ? 'current' : '']"
          @click="view3compare"
        >
          按经营单元对比 </i-button
        ><i-button
          type="primary"
          :class="[view3 == 'date' ? 'current' : '']"
          @click="view3date"
        >
          时序图
        </i-button>
        ...
        <div class="icon-item">
          <div class="layout">
            ...
            <div class="text data">
              {{
                view_1_obj[9]
                  ? format(Number(view_1_obj[9].idxValue).toFixed(0))
                  : 0
              }}个
            </div>
          </div>
        ...
        <div class="icon-item">
          <div class="layout">
            ...
            <div class="text data">
              {{
                view_1_obj[10]
                  ? format(Number(view_1_obj[10].idxValue).toFixed(0))
                  : 0
              }}笔/{{
                view_1_obj[11]
                  ? Number(view_1_obj[11].idxValue * 100).toFixed(2)
                  : 0
              }}%
            </div>
          </div>
        ...
        <div class="icon-item">
          <div class="layout">
            ...
            <div class="text data">
              {{
                view_1_obj[12]
                  ? format(Number(view_1_obj[12].idxValue).toFixed(0))
                  : 0
              }}个
            </div>
          </div>
        ...
        <div class="icon-item">
          <div class="layout">
            ...
            <div class="text data">
              {{
                view_1_obj[13]
                  ? format(Number(view_1_obj[13].idxValue).toFixed(0))
                  : 0
              }}元/{{
                view_1_obj[14]
                  ? Number(view_1_obj[14].idxValue * 100).toFixed(2)
                  : 0
              }}%
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    view3compare() {
      this.view3 = 'compare'
      const bar_box = this.$echarts.init(
        document.getElementById('view_left_bottom')
      )
      bar_box.clear()
    ...
    view5compare() {
      this.view5 = 'compare'
      const bar_box = this.$echarts.init(
        document.getElementById('view_right_top')
      )
      bar_box.clear()
    ...
    async getEncodesAndRequestData() {
      ...
      const datesArr = getMonthsArr(
        this.month.split('-')[0],
        this.month.split('-')[1],
        13,
        '-'
      )
      const currentYearDateArr = getMonthsArr(
        this.month.split('-')[0],
        12,
        12,
        '-'
      )
      const dateArrName = getMonthsArr(
        this.month.split('-')[0],
        this.month.split('-')[1],
        13,
        '/'
      )
      const currentYearDateArrName = getMonthsArr(
        this.month.split('-')[0],
        12,
        12,
        '/'
      ...
      const bar_box_1 = this.$echarts.init(
        document.getElementById('view_left_top')
      )
      const bar_box_2 = this.$echarts.init(
        document.getElementById('view_left_bottom')
      )
      const bar_box_3 = this.$echarts.init(
        document.getElementById('view_right_top')
      )
      const bar_box_4 = this.$echarts.init(
        document.getElementById('view_right_bottom')
      )
      ...
      this.$http
        ...
        .then((res) => {
          ...
          const sumValueDaraArr = t_data[view10encodes_2[1]].map(
            (ele, index) => {
